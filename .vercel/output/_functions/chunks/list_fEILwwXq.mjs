...
//#region src/pages/en/terms/list.astro
...
var $$List = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "PageLayout", $$BaseLayout, { "meta": {
		...
		"href": "/en",
		"style": "back"
	})} ${maybeRenderHead($$result)}<main class="mt-6 lg:mt-10"> <div id="content-header" class="animate"> <h1 class="mb-6 text-3xl font-medium">Site Policy</h1> </div> <div id="content"${addAttribute(cn("animate mt-8 max-w-none md:min-w-[45ch]", integ.typography.class), "class")}> <h2 class="text-xl font-medium">Site policy documentation</h2> ${renderComponent($$result, "CardList", $$CardList, { ...terms })} </div> </main> ` })}`;
}, "C:/Users/22790/astro-blog2/src/pages/en/terms/list.astro", void 0);
var $$file = "C:/Users/22790/astro-blog2/src/pages/en/terms/list.astro";
var $$url = "/en/terms/list";
//#endregion
//#region \0virtual:astro:page:src/pages/en/terms/list@_@astro
